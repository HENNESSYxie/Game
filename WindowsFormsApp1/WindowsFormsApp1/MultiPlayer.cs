...
namespace WindowsFormsApp1
{
    ...
    public partial class MultiPlayer : Form
    {
        ...
        GameModel gameModel;
        View view;
        public MultiPlayer(string txt1, string txt2)
        {
            InitializeComponent();
            SoundPlayer = new System.Media.SoundPlayer(Properties.Resources.SOAD_TOXICITY);
            SoundPlayer.PlayLooping();
            gameModel = new GameModel(new Player(txt1), new Player(txt2),this);
            view = new View(gameModel, this);
            view.ShowInformation();
            pictureBox1.BackgroundImage = Properties.Resources.Arrow_right;
            gameModel.PlaceImagesToButtons();
            gameModel.PlaceImagesToButtons2();
        }

        private void button_Click(object sender, EventArgs e)
        {
            gameModel.MakeMove(sender);
            view.ShowInformation();
        }
        ...
        {
            gameModel.MakeMoveSecondPlayer(sender);
            view.ShowInformation();
        }
    ...
    public class View
    {
        GameModel gameModel;
        MultiPlayer f1;
        public View(GameModel gameModel, MultiPlayer f1)
        {
        ...
        public void ShowInformation() // отображает информацию об игроках на контролах
        {
            ...
            f1.label8.Text = gameModel.enemy.Health.ToString();
            f1.progressBar2.Value = gameModel.enemy.Health;
            f1.label5.Text = $"NAME : {gameModel.you.Name}";
            f1.label6.Text = $"NAME : {gameModel.enemy.Name}";
            f1.label1.Text = $"ATTACK LEVEL : {gameModel.you.AttackLevel}";
            f1.label2.Text = $"DEFENSE LEVEL : {gameModel.you.DefenseLevel}";
            f1.label4.Text = $"ATTACK LEVEL : {gameModel.enemy.AttackLevel}";
            f1.label3.Text = $"DEFENSE LEVEL : {gameModel.enemy.DefenseLevel}";
        }
    }
    ...
    public class GameModel
    {
        ...
        public GameModel(Player you, Player enemy, MultiPlayer f1)
        {
            this.you = you;
            this.enemy = enemy;
            this.f1 = f1;
