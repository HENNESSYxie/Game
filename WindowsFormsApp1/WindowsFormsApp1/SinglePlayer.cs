...
namespace WindowsFormsApp1
{
    ...
    public partial class SinglePlayer : Form
    {
        ...
        public SinglePlayer(string txt1, string txt2)
        {
            ...
            GameModeWithNPC = new GameModeWithNPC(new Player(txt1), new Player(txt2), this);
            ViewWithNPC = new ViewWithNPC(GameModeWithNPC, this);
            ViewWithNPC.ShowInformation();
            pictureBox1.BackgroundImage = Properties.Resources.Arrow_right;
            GameModeWithNPC.PlaceImagesToButtons();
            GameModeWithNPC.PlaceImagesToButtons2();
        }

        private void button_Click(object sender, EventArgs e)
        {
            GameModeWithNPC.MakeMove(sender);
            ViewWithNPC.ShowInformation();
        }

        private void timer3_Tick(object sender, EventArgs e)
        {
            GameModeWithNPC.Timer3();
        }

        private void timer4_Tick(object sender, EventArgs e)
        {
            GameModeWithNPC.Timer4();
        }
        ...
        {
            GameModeWithNPC.Timer2();
        }

        private void timer1_Tick(object sender, EventArgs e)
        {
           GameModeWithNPC.Timer1();
        }
    ...
    public class ViewWithNPC
    {
        GameModeWithNPC GameModeWithNPC;
        SinglePlayer f1;
        public ViewWithNPC(GameModeWithNPC GameModeWithNPC, SinglePlayer f1)
        {
            this.GameModeWithNPC = GameModeWithNPC;
            this.f1 = f1;
        }

        public void ShowInformation()
        {
            f1.progressBar1.Value = GameModeWithNPC.you.Health;
            f1.label7.Text = GameModeWithNPC.you.Health.ToString();
            f1.label8.Text = GameModeWithNPC.enemy.Health.ToString();
            f1.progressBar2.Value = GameModeWithNPC.enemy.Health;
            f1.label5.Text = $"NAME : {GameModeWithNPC.you.Name}";
            f1.label6.Text = $"NAME : {GameModeWithNPC.enemy.Name}";
            f1.label1.Text = $"ATTACK LEVEL : {GameModeWithNPC.you.AttackLevel}";
            f1.label2.Text = $"DEFENSE LEVEL : {GameModeWithNPC.you.DefenseLevel}";
            f1.label4.Text = $"ATTACK LEVEL : {GameModeWithNPC.enemy.AttackLevel}";
            f1.label3.Text = $"DEFENSE LEVEL : {GameModeWithNPC.enemy.DefenseLevel}";
        }
    }

    public class GameModeWithNPC
    {
        ...
        public void MakeMoveSecondPlayer()
        {
            bool takeCard = false;
            if (!yourTurn)
            {
